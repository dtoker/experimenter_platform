...
if(isset($missing_fields)){
  print $_POST['uid'];
  print $_POST['freq_pref_choice'];
  print $_POST['freq_vis_choice'];
        ...
        <p>User ID: <label>
                <b>
                    <?php if(isset($_GET['uid']))
                        {print addslashes(htmlentities($_GET['uid']));}
                    ?>
                </b></label><br /></p>
    ...
    <div>
        <ul id = 'questionList'>
            ...
            <li> <label class="description">How often do you use visualization tool to make such preferential choice?</label>
                <span>
                    <input type="radio" class="element radio" name="freq_vis_choice" value="never"><label class="choice">Never</label>
                    <input type="radio" class="element radio" name="freq_vis_choice" value="rarely"><label class="choice">Rarely (few times a year)</label>
                    <input type="radio" class="element radio" name="freq_vis_choice" value="occasionally"><label class="choice">Occasionally (several times a year)</label>
                    <input type="radio" class="element radio" name="freq_vis_choice" value="frequently"><label class="choice">Frequently (several times a month)</label>
                    <input type="radio" class="element radio" name="freq_vis_choice" value="frequently"><label class="choice">Very frequently (several times a week)</label>
                </span>
            </li>
        </ul>
